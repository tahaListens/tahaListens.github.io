...
`].filter(No).join(`
`)),c=Xf(c),c=bm(c,n),c=Pm(c,n),d=Xf(d),d=bm(d,n),d=Pm(d,n),c=Lm(c),d=Lm(d),n.isRawShaderMaterial!==!0&&(N=`#version 300 es
...
}`;function kM(s,e,n){let r=new Tg;const a=new Lt,l=new Lt,c=new Xt,d=new ox({depthPacking:v0}),h=new ax,m={},g=n.maxTextureSize,v={[wr]:Fn,[Fn]:wr,[ki]:ki},x=new Ar({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Lt},radius:{value:4}},vertexShader:FM,fragmentShader:OM}),S=x.clone();S.defines.HORIZONTAL_PASS=1;const T=new Xi;T.setAttribute("position",new yi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const w=new Hi(T,x),y=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=tg;let _=this.type;this.render=function(H,U,q){if(y.enabled===!1||y.autoUpdate===!1&&y.needsUpdate===!1||H.length===0)return;const P=s.getRenderTarget(),C=s.getActiveCubeFace(),z=s.getActiveMipmapLevel(),re=s.state;re.setBlending(Er),re.buffers.color.setClear(1,1,1,1),re.buffers.depth.setTest(!0),re.setScissorTest(!1);const ee=_!==Oi&&this.type===Oi,fe=_===Oi&&this.type!==Oi;for(let ue=0,le=H.length;ue<le;ue++){const oe=H[ue],B=oe.shadow;if(B===void 0){console.warn("THREE.WebGLShadowMap:",oe,"has no shadow.");continue}if(B.autoUpdate===!1&&B.needsUpdate===!1)continue;a.copy(B.mapSize);const ae=B.getFrameExtents();if(a.multiply(ae),l.copy(B.mapSize),(a.x>g||a.y>g)&&(a.x>g&&(l.x=Math.floor(g/ae.x),a.x=l.x*ae.x,B.mapSize.x=l.x),a.y>g&&(l.y=Math.floor(g/ae.y),a.y=l.y*ae.y,B.mapSize.y=l.y)),B.map===null||ee===!0||fe===!0){const R=this.type!==Oi?{minFilter:fi,magFilter:fi}:{};B.map!==null&&B.map.dispose(),B.map=new es(a.x,a.y,R),B.map.texture.name=oe.name+".shadowMap",B.camera.updateProjectionMatrix()}s.setRenderTarget(B.map),s.clear();const F=B.getViewportCount();for(let R=0;R<F;R++){const W=B.getViewport(R);c.set(l.x*W.x,l.y*W.y,l.x*W.z,l.y*W.w),re.viewport(c),B.updateMatrices(oe,R),r=B.getFrustum(),b(U,q,B.camera,oe,this.type)}B.isPointLightShadow!==!0&&this.type===Oi&&N(B,q),B.needsUpdate=!1}_=this.type,y.needsUpdate=!1,s.setRenderTarget(P,C,z)};function N(H,U){const q=e.update(w);x.defines.VSM_SAMPLES!==H.blurSamples&&(x.defines.VSM_SAMPLES=H.blurSamples,S.defines.VSM_SAMPLES=H.blurSamples,x.needsUpdate=!0,S.needsUpdate=!0),H.mapPass===null&&(H.mapPass=new es(a.x,a.y)),x.uniforms.shadow_pass.value=H.map.texture,x.uniforms.resolution.value=H.mapSize,x.uniforms.radius.value=H.radius,s.setRenderTarget(H.mapPass),s.clear(),s.renderBufferDirect(U,null,q,x,w,null),S.uniforms.shadow_pass.value=H.mapPass.texture,S.uniforms.resolution.value=H.mapSize,S.uniforms.radius.value=H.radius,s.setRenderTarget(H.map),s.clear(),s.renderBufferDirect(U,null,q,S,w,null)}function I(H,U,q,P){let C=null;const z=q.isPointLight===!0?H.customDistanceMaterial:H.customDepthMaterial;if(z!==void 0)C=z;else if(C=q.isPointLight===!0?h:d,s.localClippingEnabled&&U.clipShadows===!0&&Array.isArray(U.clippingPlanes)&&U.clippingPlanes.length!==0||U.displacementMap&&U.displacementScale!==0||U.alphaMap&&U.alphaTest>0||U.map&&U.alphaTest>0||U.alphaToCoverage===!0){const re=C.uuid,ee=U.uuid;let fe=m[re];fe===void 0&&(fe={},m[re]=fe);let ue=fe[ee];ue===void 0&&(ue=C.clone(),fe[ee]=ue,U.addEventListener("dispose",j)),C=ue}if(C.visible=U.visible,C.wireframe=U.wireframe,P===Oi?C.side=U.shadowSide!==null?U.shadowSide:U.side:C.side=U.shadowSide!==null?U.shadowSide:v[U.side],C.alphaMap=U.alphaMap,C.alphaTest=U.alphaToCoverage===!0?.5:U.alphaTest,C.map=U.map,C.clipShadows=U.clipShadows,C.clippingPlanes=U.clippingPlanes,C.clipIntersection=U.clipIntersection,C.displacementMap=U.displacementMap,C.displacementScale=U.displacementScale,C.displacementBias=U.displacementBias,C.wireframeLinewidth=U.wireframeLinewidth,C.linewidth=U.linewidth,q.isPointLight===!0&&C.isMeshDistanceMaterial===!0){const re=s.properties.get(C);re.light=q}return C}function b(H,U,q,P,C){if(H.visible===!1)return;if(H.layers.test(U.layers)&&(H.isMesh||H.isLine||H.isPoints)&&(H.castShadow||H.receiveShadow&&C===Oi)&&(!H.frustumCulled||r.intersectsObject(H))){H.modelViewMatrix.multiplyMatrices(q.matrixWorldInverse,H.matrixWorld);const ee=e.update(H),fe=H.material;if(Array.isArray(fe)){const ue=ee.groups;for(let le=0,oe=ue.length;le<oe;le++){const B=ue[le],ae=fe[B.materialIndex];if(ae&&ae.visible){const F=I(H,ae,P,C);H.onBeforeShadow(s,H,U,q,ee,F,B),s.renderBufferDirect(q,null,ee,F,H,B),H.onAfterShadow(s,H,U,q,ee,F,B)}}}else if(fe.visible){const ue=I(H,fe,P,C);H.onBeforeShadow(s,H,U,q,ee,ue,null),s.renderBufferDirect(q,null,ee,ue,H,null),H.onAfterShadow(s,H,U,q,ee,ue,null)}}const re=H.children;for(let ee=0,fe=re.length;ee<fe;ee++)b(re[ee],U,q,P,C)}function j(H){H.target.removeEventListener("dispose",j);for(const q in m){const P=m[q],C=H.target.uuid;C in P&&(P[C].dispose(),delete P[C])}}}const BM={[of]:af,[lf]:ff,[uf]:df,[Vs]:cf,[af]:of,[ff]:lf,[df]:uf,[cf]:Vs};function zM(s,e){function n(){let G=!1;const Re=new Xt;let se=null;const pe=new Xt(0,0,0,0);return{setMask:function(De){se!==De&&!G&&(s.colorMask(De,De,De,De),se=De)},setLocked:function(De){G=De},setClear:function(De,Le,ot,It,Zt){Zt===!0&&(De*=It,Le*=It,ot*=It),Re.set(De,Le,ot,It),pe.equals(Re)===!1&&(s.clearColor(De,Le,ot,It),pe.copy(Re))},reset:function(){G=!1,se=null,pe.set(-1,0,0,0)}}}function r(){let G=!1,Re=!1,se=null,pe=null,De=null;return{setReversed:function(Le){if(Re!==Le){const ot=e.get("EXT_clip_control");Le?ot.clipControlEXT(ot.LOWER_LEFT_EXT,ot.ZERO_TO_ONE_EXT):ot.clipControlEXT(ot.LOWER_LEFT_EXT,ot.NEGATIVE_ONE_TO_ONE_EXT),Re=Le;const It=De;De=null,this.setClear(It)}},getReversed:function(){return Re},setTest:function(Le){Le?me(s.DEPTH_TEST):we(s.DEPTH_TEST)},setMask:function(Le){se!==Le&&!G&&(s.depthMask(Le),se=Le)},setFunc:function(Le){if(Re&&(Le=BM[Le]),pe!==Le){switch(Le){case of:s.depthFunc(s.NEVER);break;case af:s.depthFunc(s.ALWAYS);break;case lf:s.depthFunc(s.LESS);break;case Vs:s.depthFunc(s.LEQUAL);break;case uf:s.depthFunc(s.EQUAL);break;case cf:s.depthFunc(s.GEQUAL);break;case ff:s.depthFunc(s.GREATER);break;case df:s.depthFunc(s.NOTEQUAL);break;default:s.depthFunc(s.LEQUAL)}pe=Le}},setLocked:function(Le){G=Le},setClear:function(Le){De!==Le&&(Re&&(Le=1-Le),s.clearDepth(Le),De=Le)},reset:function(){G=!1,se=null,pe=null,De=null,Re=!1}}}function a(){let G=!1,Re=null,se=null,pe=null,De=null,Le=null,ot=null,It=null,Zt=null;return{setTest:function(xt){G||(xt?me(s.STENCIL_TEST):we(s.STENCIL_TEST))},setMask:function(xt){Re!==xt&&!G&&(s.stencilMask(xt),Re=xt)},setFunc:function(xt,Cn,Sn){(se!==xt||pe!==Cn||De!==Sn)&&(s.stencilFunc(xt,Cn,Sn),se=xt,pe=Cn,De=Sn)},setOp:function(xt,Cn,Sn){(Le!==xt||ot!==Cn||It!==Sn)&&(s.stencilOp(xt,Cn,Sn),Le=xt,ot=Cn,It=Sn)},setLocked:function(xt){G=xt},setClear:function(xt){Zt!==xt&&(s.clearStencil(xt),Zt=xt)},reset:function(){G=!1,Re=null,se=null,pe=null,De=null,Le=null,ot=null,It=null,Zt=null}}}const l=new n,c=new r,d=new a,h=new WeakMap,m=new WeakMap;let g={},v={},x=new WeakMap,S=[],T=null,w=!1,y=null,_=null,N=null,I=null,b=null,j=null,H=null,U=new Et(0,0,0),q=0,P=!1,C=null,z=null,re=null,ee=null,fe=null;const ue=s.getParameter(s.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let le=!1,oe=0;const B=s.getParameter(s.VERSION);B.indexOf("WebGL")!==-1?(oe=parseFloat(/^WebGL (\d)/.exec(B)[1]),le=oe>=1):B.indexOf("OpenGL ES")!==-1&&(oe=parseFloat(/^OpenGL ES (\d)/.exec(B)[1]),le=oe>=2);let ae=null,F={};const R=s.getParameter(s.SCISSOR_BOX),W=s.getParameter(s.VIEWPORT),Me=new Xt().fromArray(R),$=new Xt().fromArray(W);function ce(G,Re,se,pe){const De=new Uint8Array(4),Le=s.createTexture();s.bindTexture(G,Le),s.texParameteri(G,s.TEXTURE_MIN_FILTER,s.NEAREST),s.texParameteri(G,s.TEXTURE_MAG_FILTER,s.NEAREST);for(let ot=0;ot<se;ot++)G===s.TEXTURE_3D||G===s.TEXTURE_2D_ARRAY?s.texImage3D(Re,0,s.RGBA,1,1,pe,0,s.RGBA,s.UNSIGNED_BYTE,De):s.texImage2D(Re+ot,0,s.RGBA,1,1,0,s.RGBA,s.UNSIGNED_BYTE,De);return Le}const _e={};_e[s.TEXTURE_2D]=ce(s.TEXTURE_2D,s.TEXTURE_2D,1),_e[s.TEXTURE_CUBE_MAP]=ce(s.TEXTURE_CUBE_MAP,s.TEXTURE_CUBE_MAP_POSITIVE_X,6),_e[s.TEXTURE_2D_ARRAY]=ce(s.TEXTURE_2D_ARRAY,s.TEXTURE_2D_ARRAY,1,1),_e[s.TEXTURE_3D]=ce(s.TEXTURE_3D,s.TEXTURE_3D,1,1),l.setClear(0,0,0,1),c.setClear(1),d.setClear(0),me(s.DEPTH_TEST),c.setFunc(Vs),pt(!1),ft(kp),me(s.CULL_FACE),k(Er);function me(G){g[G]!==!0&&(s.enable(G),g[G]=!0)}function we(G){g[G]!==!1&&(s.disable(G),g[G]=!1)}function He(G,Re){return v[G]!==Re?(s.bindFramebuffer(G,Re),v[G]=Re,G===s.DRAW_FRAMEBUFFER&&(v[s.FRAMEBUFFER]=Re),G===s.FRAMEBUFFER&&(v[s.DRAW_FRAMEBUFFER]=Re),!0):!1}function Ue(G,Re){let se=S,pe=!1;if(G){se=x.get(Re),se===void 0&&(se=[],x.set(Re,se));const De=G.textures;if(se.length!==De.length||se[0]!==s.COLOR_ATTACHMENT0){for(let Le=0,ot=De.length;Le<ot;Le++)se[Le]=s.COLOR_ATTACHMENT0+Le;se.length=De.length,pe=!0}}else se[0]!==s.BACK&&(se[0]=s.BACK,pe=!0);pe&&s.drawBuffers(se)}function tt(G){return T!==G?(s.useProgram(G),T=G,!0):!1}const wt={[$r]:s.FUNC_ADD,[G_]:s.FUNC_SUBTRACT,[W_]:s.FUNC_REVERSE_SUBTRACT};wt[X_]=s.MIN,wt[j_]=s.MAX;const at={[Y_]:s.ZERO,[q_]:s.ONE,[$_]:s.SRC_COLOR,[rf]:s.SRC_ALPHA,[t0]:s.SRC_ALPHA_SATURATE,[J_]:s.DST_COLOR,[Z_]:s.DST_ALPHA,[K_]:s.ONE_MINUS_SRC_COLOR,[sf]:s.ONE_MINUS_SRC_ALPHA,[e0]:s.ONE_MINUS_DST_COLOR,[Q_]:s.ONE_MINUS_DST_ALPHA,[n0]:s.CONSTANT_COLOR,[i0]:s.ONE_MINUS_CONSTANT_COLOR,[r0]:s.CONSTANT_ALPHA,[s0]:s.ONE_MINUS_CONSTANT_ALPHA};function k(G,Re,se,pe,De,Le,ot,It,Zt,xt){if(G===Er){w===!0&&(we(s.BLEND),w=!1);return}if(w===!1&&(me(s.BLEND),w=!0),G!==V_){if(G!==y||xt!==P){if((_!==$r||b!==$r)&&(s.blendEquation(s.FUNC_ADD),_=$r,b=$r),xt)switch(G){case zs:s.blendFuncSeparate(s.ONE,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Bp:s.blendFunc(s.ONE,s.ONE);break;case zp:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Hp:s.blendFuncSeparate(s.ZERO,s.SRC_COLOR,s.ZERO,s.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",G);break}else switch(G){case zs:s.blendFuncSeparate(s.SRC_ALPHA,s.ONE_MINUS_SRC_ALPHA,s.ONE,s.ONE_MINUS_SRC_ALPHA);break;case Bp:s.blendFunc(s.SRC_ALPHA,s.ONE);break;case zp:s.blendFuncSeparate(s.ZERO,s.ONE_MINUS_SRC_COLOR,s.ZERO,s.ONE);break;case Hp:s.blendFunc(s.ZERO,s.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",G);break}N=null,I=null,j=null,H=null,U.set(0,0,0),q=0,y=G,P=xt}return}De=De||Re,Le=Le||se,ot=ot||pe,(Re!==_||De!==b)&&(s.blendEquationSeparate(wt[Re],wt[De]),_=Re,b=De),(se!==N||pe!==I||Le!==j||ot!==H)&&(s.blendFuncSeparate(at[se],at[pe],at[Le],at[ot]),N=se,I=pe,j=Le,H=ot),(It.equals(U)===!1||Zt!==q)&&(s.blendColor(It.r,It.g,It.b,Zt),U.copy(It),q=Zt),y=G,P=!1}function yn(G,Re){G.side===ki?we(s.CULL_FACE):me(s.CULL_FACE);let se=G.side===Fn;Re&&(se=!se),pt(se),G.blending===zs&&G.transparent===!1?k(Er):k(G.blending,G.blendEquation,G.blendSrc,G.blendDst,G.blendEquationAlpha,G.blendSrcAlpha,G.blendDstAlpha,G.blendColor,G.blendAlpha,G.premultipliedAlpha),c.setFunc(G.depthFunc),c.setTest(G.depthTest),c.setMask(G.depthWrite),l.setMask(G.colorWrite);const pe=G.stencilWrite;d.setTest(pe),pe&&(d.setMask(G.stencilWriteMask),d.setFunc(G.stencilFunc,G.stencilRef,G.stencilFuncMask),d.setOp(G.stencilFail,G.stencilZFail,G.stencilZPass)),Rt(G.polygonOffset,G.polygonOffsetFactor,G.polygonOffsetUnits),G.alphaToCoverage===!0?me(s.SAMPLE_ALPHA_TO_COVERAGE):we(s.SAMPLE_ALPHA_TO_COVERAGE)}function pt(G){C!==G&&(G?s.frontFace(s.CW):s.frontFace(s.CCW),C=G)}function ft(G){G!==B_?(me(s.CULL_FACE),G!==z&&(G===kp?s.cullFace(s.BACK):G===z_?s.cullFace(s.FRONT):s.cullFace(s.FRONT_AND_BACK))):we(s.CULL_FACE),z=G}function Ye(G){G!==re&&(le&&s.lineWidth(G),re=G)}function Rt(G,Re,se){G?(me(s.POLYGON_OFFSET_FILL),(ee!==Re||fe!==se)&&(s.polygonOffset(Re,se),ee=Re,fe=se)):we(s.POLYGON_OFFSET_FILL)}function Xe(G){G?me(s.SCISSOR_TEST):we(s.SCISSOR_TEST)}function L(G){G===void 0&&(G=s.TEXTURE0+ue-1),ae!==G&&(s.activeTexture(G),ae=G)}function M(G,Re,se){se===void 0&&(ae===null?se=s.TEXTURE0+ue-1:se=ae);let pe=F[se];pe===void 0&&(pe={type:void 0,texture:void 0},F[se]=pe),(pe.type!==G||pe.texture!==Re)&&(ae!==se&&(s.activeTexture(se),ae=se),s.bindTexture(G,Re||_e[G]),pe.type=G,pe.texture=Re)}function J(){const G=F[ae];G!==void 0&&G.type!==void 0&&(s.bindTexture(G.type,null),G.type=void 0,G.texture=void 0)}function he(){try{s.compressedTexImage2D(...arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function ye(){try{s.compressedTexImage3D(...arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function de(){try{s.texSubImage2D(...arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function We(){try{s.texSubImage3D(...arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function Ce(){try{s.compressedTexSubImage2D(...arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function Ke(){try{s.compressedTexSubImage3D(...arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function $e(){try{s.texStorage2D(...arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function Se(){try{s.texStorage3D(...arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function Oe(){try{s.texImage2D(...arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function et(){try{s.texImage3D(...arguments)}catch(G){console.error("THREE.WebGLState:",G)}}function nt(G){Me.equals(G)===!1&&(s.scissor(G.x,G.y,G.z,G.w),Me.copy(G))}function ke(G){$.equals(G)===!1&&(s.viewport(G.x,G.y,G.z,G.w),$.copy(G))}function dt(G,Re){let se=m.get(Re);se===void 0&&(se=new WeakMap,m.set(Re,se));let pe=se.get(G);pe===void 0&&(pe=s.getUniformBlockIndex(Re,G.name),se.set(G,pe))}function st(G,Re){const pe=m.get(Re).get(G);h.get(Re)!==pe&&(s.uniformBlockBinding(Re,pe,G.__bindingPointIndex),h.set(Re,pe))}function Ct(){s.disable(s.BLEND),s.disable(s.CULL_FACE),s.disable(s.DEPTH_TEST),s.disable(s.POLYGON_OFFSET_FILL),s.disable(s.SCISSOR_TEST),s.disable(s.STENCIL_TEST),s.disable(s.SAMPLE_ALPHA_TO_COVERAGE),s.blendEquation(s.FUNC_ADD),s.blendFunc(s.ONE,s.ZERO),s.blendFuncSeparate(s.ONE,s.ZERO,s.ONE,s.ZERO),s.blendColor(0,0,0,0),s.colorMask(!0,!0,!0,!0),s.clearColor(0,0,0,0),s.depthMask(!0),s.depthFunc(s.LESS),c.setReversed(!1),s.clearDepth(1),s.stencilMask(4294967295),s.stencilFunc(s.ALWAYS,0,4294967295),s.stencilOp(s.KEEP,s.KEEP,s.KEEP),s.clearStencil(0),s.cullFace(s.BACK),s.frontFace(s.CCW),s.polygonOffset(0,0),s.activeTexture(s.TEXTURE0),s.bindFramebuffer(s.FRAMEBUFFER,null),s.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),s.bindFramebuffer(s.READ_FRAMEBUFFER,null),s.useProgram(null),s.lineWidth(1),s.scissor(0,0,s.canvas.width,s.canvas.height),s.viewport(0,0,s.canvas.width,s.canvas.height),g={},ae=null,F={},v={},x=new WeakMap,S=[],T=null,w=!1,y=null,_=null,N=null,I=null,b=null,j=null,H=null,U=new Et(0,0,0),q=0,P=!1,C=null,z=null,re=null,ee=null,fe=null,Me.set(0,0,s.canvas.width,s.canvas.height),$.set(0,0,s.canvas.width,s.canvas.height),l.reset(),c.reset(),d.reset()}return{buffers:{color:l,depth:c,stencil:d},enable:me,disable:we,bindFramebuffer:He,drawBuffers:Ue,useProgram:tt,setBlending:k,setMaterial:yn,setFlipSided:pt,setCullFace:ft,setLineWidth:Ye,setPolygonOffset:Rt,setScissorTest:Xe,activeTexture:L,bindTexture:M,unbindTexture:J,compressedTexImage2D:he,compressedTexImage3D:ye,texImage2D:Oe,texImage3D:et,updateUBOMapping:dt,uniformBlockBinding:st,texStorage2D:$e,texStorage3D:Se,texSubImage2D:de,texSubImage3D:We,compressedTexSubImage2D:Ce,compressedTexSubImage3D:Ke,scissor:nt,viewport:ke,reset:Ct}}function HM(s,e,n,r,a,l,c){const d=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,h=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),m=new Lt,g=new WeakMap;let v;const x=new WeakMap;let S=!1;try{S=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function T(L,M){return S?new OffscreenCanvas(L,M):Bo("canvas")}function w(L,M,J){let he=1;const ye=Xe(L);if((ye.width>J||ye.height>J)&&(he=J/Math.max(ye.width,ye.height)),he<1)if(typeof HTMLImageElement<"u"&&L instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&L instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&L instanceof ImageBitmap||typeof VideoFrame<"u"&&L instanceof VideoFrame){const de=Math.floor(he*ye.width),We=Math.floor(he*ye.height);v===void 0&&(v=T(de,We));const Ce=M?T(de,We):v;return Ce.width=de,Ce.height=We,Ce.getContext("2d").drawImage(L,0,0,de,We),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ye.width+"x"+ye.height+") to ("+de+"x"+We+")."),Ce}else return"data"in L&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ye.width+"x"+ye.height+")."),L;return L}function y(L){return L.generateMipmaps}function _(L){s.generateMipmap(L)}function N(L){return L.isWebGLCubeRenderTarget?s.TEXTURE_CUBE_MAP:L.isWebGL3DRenderTarget?s.TEXTURE_3D:L.isWebGLArrayRenderTarget||L.isCompressedArrayTexture?s.TEXTURE_2D_ARRAY:s.TEXTURE_2D}function I(L,M,J,he,ye=!1){if(L!==null){if(s[L]!==void 0)return s[L];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+L+"'")}let de=M;if(M===s.RED&&(J===s.FLOAT&&(de=s.R32F),J===s.HALF_FLOAT&&(de=s.R16F),J===s.UNSIGNED_BYTE&&(de=s.R8)),M===s.RED_INTEGER&&(J===s.UNSIGNED_BYTE&&(de=s.R8UI),J===s.UNSIGNED_SHORT&&(de=s.R16UI),J===s.UNSIGNED_INT&&(de=s.R32UI),J===s.BYTE&&(de=s.R8I),J===s.SHORT&&(de=s.R16I),J===s.INT&&(de=s.R32I)),M===s.RG&&(J===s.FLOAT&&(de=s.RG32F),J===s.HALF_FLOAT&&(de=s.RG16F),J===s.UNSIGNED_BYTE&&(de=s.RG8)),M===s.RG_INTEGER&&(J===s.UNSIGNED_BYTE&&(de=s.RG8UI),J===s.UNSIGNED_SHORT&&(de=s.RG16UI),J===s.UNSIGNED_INT&&(de=s.RG32UI),J===s.BYTE&&(de=s.RG8I),J===s.SHORT&&(de=s.RG16I),J===s.INT&&(de=s.RG32I)),M===s.RGB_INTEGER&&(J===s.UNSIGNED_BYTE&&(de=s.RGB8UI),J===s.UNSIGNED_SHORT&&(de=s.RGB16UI),J===s.UNSIGNED_INT&&(de=s.RGB32UI),J===s.BYTE&&(de=s.RGB8I),J===s.SHORT&&(de=s.RGB16I),J===s.INT&&(de=s.RGB32I)),M===s.RGBA_INTEGER&&(J===s.UNSIGNED_BYTE&&(de=s.RGBA8UI),J===s.UNSIGNED_SHORT&&(de=s.RGBA16UI),J===s.UNSIGNED_INT&&(de=s.RGBA32UI),J===s.BYTE&&(de=s.RGBA8I),J===s.SHORT&&(de=s.RGBA16I),J===s.INT&&(de=s.RGBA32I)),M===s.RGB&&J===s.UNSIGNED_INT_5_9_9_9_REV&&(de=s.RGB9_E5),M===s.RGBA){const We=ye?Ll:Tt.getTransfer(he);J===s.FLOAT&&(de=s.RGBA32F),J===s.HALF_FLOAT&&(de=s.RGBA16F),J===s.UNSIGNED_BYTE&&(de=We===bt?s.SRGB8_ALPHA8:s.RGBA8),J===s.UNSIGNED_SHORT_4_4_4_4&&(de=s.RGBA4),J===s.UNSIGNED_SHORT_5_5_5_1&&(de=s.RGB5_A1)}return(de===s.R16F||de===s.R32F||de===s.RG16F||de===s.RG32F||de===s.RGBA16F||de===s.RGBA32F)&&e.get("EXT_color_buffer_float"),de}function b(L,M){let J;return L?M===null||M===Jr||M===Fo?J=s.DEPTH24_STENCIL8:M===Bi?J=s.DEPTH32F_STENCIL8:M===Uo&&(J=s.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===Jr||M===Fo?J=s.DEPTH_COMPONENT24:M===Bi?J=s.DEPTH_COMPONENT32F:M===Uo&&(J=s.DEPTH_COMPONENT16),J}function j(L,M){return y(L)===!0||L.isFramebufferTexture&&L.minFilter!==fi&&L.minFilter!==xi?Math.log2(Math.max(M.width,M.height))+1:L.mipmaps!==void 0&&L.mipmaps.length>0?L.mipmaps.length:L.isCompressedTexture&&Array.isArray(L.image)?M.mipmaps.length:1}function H(L){const M=L.target;M.removeEventListener("dispose",H),q(M),M.isVideoTexture&&g.delete(M)}function U(L){const M=L.target;M.removeEventListener("dispose",U),C(M)}function q(L){const M=r.get(L);if(M.__webglInit===void 0)return;const J=L.source,he=x.get(J);if(he){const ye=he[M.__cacheKey];ye.usedTimes--,ye.usedTimes===0&&P(L),Object.keys(he).length===0&&x.delete(J)}r.remove(L)}function P(L){const M=r.get(L);s.deleteTexture(M.__webglTexture);const J=L.source,he=x.get(J);delete he[M.__cacheKey],c.memory.textures--}function C(L){const M=r.get(L);if(L.depthTexture&&(L.depthTexture.dispose(),r.remove(L.depthTexture)),L.isWebGLCubeRenderTarget)for(let he=0;he<6;he++){if(Array.isArray(M.__webglFramebuffer[he]))for(let ye=0;ye<M.__webglFramebuffer[he].length;ye++)s.deleteFramebuffer(M.__webglFramebuffer[he][ye]);else s.deleteFramebuffer(M.__webglFramebuffer[he]);M.__webglDepthbuffer&&s.deleteRenderbuffer(M.__webglDepthbuffer[he])}else{if(Array.isArray(M.__webglFramebuffer))for(let he=0;he<M.__webglFramebuffer.length;he++)s.deleteFramebuffer(M.__webglFramebuffer[he]);else s.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&s.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&s.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let he=0;he<M.__webglColorRenderbuffer.length;he++)M.__webglColorRenderbuffer[he]&&s.deleteRenderbuffer(M.__webglColorRenderbuffer[he]);M.__webglDepthRenderbuffer&&s.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const J=L.textures;for(let he=0,ye=J.length;he<ye;he++){const de=r.get(J[he]);de.__webglTexture&&(s.deleteTexture(de.__webglTexture),c.memory.textures--),r.remove(J[he])}r.remove(L)}let z=0;function re(){z=0}function ee(){const L=z;return L>=a.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+L+" texture units while this GPU supports only "+a.maxTextures),z+=1,L}function fe(L){const M=[];return M.push(L.wrapS),M.push(L.wrapT),M.push(L.wrapR||0),M.push(L.magFilter),M.push(L.minFilter),M.push(L.anisotropy),M.push(L.internalFormat),M.push(L.format),M.push(L.type),M.push(L.generateMipmaps),M.push(L.premultiplyAlpha),M.push(L.flipY),M.push(L.unpackAlignment),M.push(L.colorSpace),M.join()}function ue(L,M){const J=r.get(L);if(L.isVideoTexture&&Ye(L),L.isRenderTargetTexture===!1&&L.version>0&&J.__version!==L.version){const he=L.image;if(he===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(he.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{$(J,L,M);return}}n.bindTexture(s.TEXTURE_2D,J.__webglTexture,s.TEXTURE0+M)}function le(L,M){const J=r.get(L);if(L.version>0&&J.__version!==L.version){$(J,L,M);return}n.bindTexture(s.TEXTURE_2D_ARRAY,J.__webglTexture,s.TEXTURE0+M)}function oe(L,M){const J=r.get(L);if(L.version>0&&J.__version!==L.version){$(J,L,M);return}n.bindTexture(s.TEXTURE_3D,J.__webglTexture,s.TEXTURE0+M)}function B(L,M){const J=r.get(L);if(L.version>0&&J.__version!==L.version){ce(J,L,M);return}n.bindTexture(s.TEXTURE_CUBE_MAP,J.__webglTexture,s.TEXTURE0+M)}const ae={[mf]:s.REPEAT,[Zr]:s.CLAMP_TO_EDGE,[gf]:s.MIRRORED_REPEAT},F={[fi]:s.NEAREST,[m0]:s.NEAREST_MIPMAP_NEAREST,[el]:s.NEAREST_MIPMAP_LINEAR,[xi]:s.LINEAR,[Ec]:s.LINEAR_MIPMAP_NEAREST,[Qr]:s.LINEAR_MIPMAP_LINEAR},R={[y0]:s.NEVER,[A0]:s.ALWAYS,[S0]:s.LESS,[dg]:s.LEQUAL,[E0]:s.EQUAL,[w0]:s.GEQUAL,[M0]:s.GREATER,[T0]:s.NOTEQUAL};function W(L,M){if(M.type===Bi&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===xi||M.magFilter===Ec||M.magFilter===el||M.magFilter===Qr||M.minFilter===xi||M.minFilter===Ec||M.minFilter===el||M.minFilter===Qr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),s.texParameteri(L,s.TEXTURE_WRAP_S,ae[M.wrapS]),s.texParameteri(L,s.TEXTURE_WRAP_T,ae[M.wrapT]),(L===s.TEXTURE_3D||L===s.TEXTURE_2D_ARRAY)&&s.texParameteri(L,s.TEXTURE_WRAP_R,ae[M.wrapR]),s.texParameteri(L,s.TEXTURE_MAG_FILTER,F[M.magFilter]),s.texParameteri(L,s.TEXTURE_MIN_FILTER,F[M.minFilter]),M.compareFunction&&(s.texParameteri(L,s.TEXTURE_COMPARE_MODE,s.COMPARE_REF_TO_TEXTURE),s.texParameteri(L,s.TEXTURE_COMPARE_FUNC,R[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===fi||M.minFilter!==el&&M.minFilter!==Qr||M.type===Bi&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||r.get(M).__currentAnisotropy){const J=e.get("EXT_texture_filter_anisotropic");s.texParameterf(L,J.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,a.getMaxAnisotropy())),r.get(M).__currentAnisotropy=M.anisotropy}}}function Me(L,M){let J=!1;L.__webglInit===void 0&&(L.__webglInit=!0,M.addEventListener("dispose",H));const he=M.source;let ye=x.get(he);ye===void 0&&(ye={},x.set(he,ye));const de=fe(M);if(de!==L.__cacheKey){ye[de]===void 0&&(ye[de]={texture:s.createTexture(),usedTimes:0},c.memory.textures++,J=!0),ye[de].usedTimes++;const We=ye[L.__cacheKey];We!==void 0&&(ye[L.__cacheKey].usedTimes--,We.usedTimes===0&&P(M)),L.__cacheKey=de,L.__webglTexture=ye[de].texture}return J}function $(L,M,J){let he=s.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(he=s.TEXTURE_2D_ARRAY),M.isData3DTexture&&(he=s.TEXTURE_3D);const ye=Me(L,M),de=M.source;n.bindTexture(he,L.__webglTexture,s.TEXTURE0+J);const We=r.get(de);if(de.version!==We.__version||ye===!0){n.activeTexture(s.TEXTURE0+J);const Ce=Tt.getPrimaries(Tt.workingColorSpace),Ke=M.colorSpace===Sr?null:Tt.getPrimaries(M.colorSpace),$e=M.colorSpace===Sr||Ce===Ke?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,M.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,M.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,$e);let Se=w(M.image,!1,a.maxTextureSize);Se=Rt(M,Se);const Oe=l.convert(M.format,M.colorSpace),et=l.convert(M.type);let nt=I(M.internalFormat,Oe,et,M.colorSpace,M.isVideoTexture);W(he,M);let ke;const dt=M.mipmaps,st=M.isVideoTexture!==!0,Ct=We.__version===void 0||ye===!0,G=de.dataReady,Re=j(M,Se);if(M.isDepthTexture)nt=b(M.format===ko,M.type),Ct&&(st?n.texStorage2D(s.TEXTURE_2D,1,nt,Se.width,Se.height):n.texImage2D(s.TEXTURE_2D,0,nt,Se.width,Se.height,0,Oe,et,null));else if(M.isDataTexture)if(dt.length>0){st&&Ct&&n.texStorage2D(s.TEXTURE_2D,Re,nt,dt[0].width,dt[0].height);for(let se=0,pe=dt.length;se<pe;se++)ke=dt[se],st?G&&n.texSubImage2D(s.TEXTURE_2D,se,0,0,ke.width,ke.height,Oe,et,ke.data):n.texImage2D(s.TEXTURE_2D,se,nt,ke.width,ke.height,0,Oe,et,ke.data);M.generateMipmaps=!1}else st?(Ct&&n.texStorage2D(s.TEXTURE_2D,Re,nt,Se.width,Se.height),G&&n.texSubImage2D(s.TEXTURE_2D,0,0,0,Se.width,Se.height,Oe,et,Se.data)):n.texImage2D(s.TEXTURE_2D,0,nt,Se.width,Se.height,0,Oe,et,Se.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){st&&Ct&&n.texStorage3D(s.TEXTURE_2D_ARRAY,Re,nt,dt[0].width,dt[0].height,Se.depth);for(let se=0,pe=dt.length;se<pe;se++)if(ke=dt[se],M.format!==ci)if(Oe!==null)if(st){if(G)if(M.layerUpdates.size>0){const De=fm(ke.width,ke.height,M.format,M.type);for(const Le of M.layerUpdates){const ot=ke.data.subarray(Le*De/ke.data.BYTES_PER_ELEMENT,(Le+1)*De/ke.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,se,0,0,Le,ke.width,ke.height,1,Oe,ot)}M.clearLayerUpdates()}else n.compressedTexSubImage3D(s.TEXTURE_2D_ARRAY,se,0,0,0,ke.width,ke.height,Se.depth,Oe,ke.data)}else n.compressedTexImage3D(s.TEXTURE_2D_ARRAY,se,nt,ke.width,ke.height,Se.depth,0,ke.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else st?G&&n.texSubImage3D(s.TEXTURE_2D_ARRAY,se,0,0,0,ke.width,ke.height,Se.depth,Oe,et,ke.data):n.texImage3D(s.TEXTURE_2D_ARRAY,se,nt,ke.width,ke.height,Se.depth,0,Oe,et,ke.data)}else{st&&Ct&&n.texStorage2D(s.TEXTURE_2D,Re,nt,dt[0].width,dt[0].height);for(let se=0,pe=dt.length;se<pe;se++)ke=dt[se],M.format!==ci?Oe!==null?st?G&&n.compressedTexSubImage2D(s.TEXTURE_2D,se,0,0,ke.width,ke.height,Oe,ke.data):n.compressedTexImage2D(s.TEXTURE_2D,se,nt,ke.width,ke.height,0,ke.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):st?G&&n.texSubImage2D(s.TEXTURE_2D,se,0,0,ke.width,ke.height,Oe,et,ke.data):n.texImage2D(s.TEXTURE_2D,se,nt,ke.width,ke.height,0,Oe,et,ke.data)}else if(M.isDataArrayTexture)if(st){if(Ct&&n.texStorage3D(s.TEXTURE_2D_ARRAY,Re,nt,Se.width,Se.height,Se.depth),G)if(M.layerUpdates.size>0){const se=fm(Se.width,Se.height,M.format,M.type);for(const pe of M.layerUpdates){const De=Se.data.subarray(pe*se/Se.data.BYTES_PER_ELEMENT,(pe+1)*se/Se.data.BYTES_PER_ELEMENT);n.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,pe,Se.width,Se.height,1,Oe,et,De)}M.clearLayerUpdates()}else n.texSubImage3D(s.TEXTURE_2D_ARRAY,0,0,0,0,Se.width,Se.height,Se.depth,Oe,et,Se.data)}else n.texImage3D(s.TEXTURE_2D_ARRAY,0,nt,Se.width,Se.height,Se.depth,0,Oe,et,Se.data);else if(M.isData3DTexture)st?(Ct&&n.texStorage3D(s.TEXTURE_3D,Re,nt,Se.width,Se.height,Se.depth),G&&n.texSubImage3D(s.TEXTURE_3D,0,0,0,0,Se.width,Se.height,Se.depth,Oe,et,Se.data)):n.texImage3D(s.TEXTURE_3D,0,nt,Se.width,Se.height,Se.depth,0,Oe,et,Se.data);else if(M.isFramebufferTexture){if(Ct)if(st)n.texStorage2D(s.TEXTURE_2D,Re,nt,Se.width,Se.height);else{let se=Se.width,pe=Se.height;for(let De=0;De<Re;De++)n.texImage2D(s.TEXTURE_2D,De,nt,se,pe,0,Oe,et,null),se>>=1,pe>>=1}}else if(dt.length>0){if(st&&Ct){const se=Xe(dt[0]);n.texStorage2D(s.TEXTURE_2D,Re,nt,se.width,se.height)}for(let se=0,pe=dt.length;se<pe;se++)ke=dt[se],st?G&&n.texSubImage2D(s.TEXTURE_2D,se,0,0,Oe,et,ke):n.texImage2D(s.TEXTURE_2D,se,nt,Oe,et,ke);M.generateMipmaps=!1}else if(st){if(Ct){const se=Xe(Se);n.texStorage2D(s.TEXTURE_2D,Re,nt,se.width,se.height)}G&&n.texSubImage2D(s.TEXTURE_2D,0,0,0,Oe,et,Se)}else n.texImage2D(s.TEXTURE_2D,0,nt,Oe,et,Se);y(M)&&_(he),We.__version=de.version,M.onUpdate&&M.onUpdate(M)}L.__version=M.version}function ce(L,M,J){if(M.image.length!==6)return;const he=Me(L,M),ye=M.source;n.bindTexture(s.TEXTURE_CUBE_MAP,L.__webglTexture,s.TEXTURE0+J);const de=r.get(ye);if(ye.version!==de.__version||he===!0){n.activeTexture(s.TEXTURE0+J);const We=Tt.getPrimaries(Tt.workingColorSpace),Ce=M.colorSpace===Sr?null:Tt.getPrimaries(M.colorSpace),Ke=M.colorSpace===Sr||We===Ce?s.NONE:s.BROWSER_DEFAULT_WEBGL;s.pixelStorei(s.UNPACK_FLIP_Y_WEBGL,M.flipY),s.pixelStorei(s.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),s.pixelStorei(s.UNPACK_ALIGNMENT,M.unpackAlignment),s.pixelStorei(s.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ke);const $e=M.isCompressedTexture||M.image[0].isCompressedTexture,Se=M.image[0]&&M.image[0].isDataTexture,Oe=[];for(let pe=0;pe<6;pe++)!$e&&!Se?Oe[pe]=w(M.image[pe],!0,a.maxCubemapSize):Oe[pe]=Se?M.image[pe].image:M.image[pe],Oe[pe]=Rt(M,Oe[pe]);const et=Oe[0],nt=l.convert(M.format,M.colorSpace),ke=l.convert(M.type),dt=I(M.internalFormat,nt,ke,M.colorSpace),st=M.isVideoTexture!==!0,Ct=de.__version===void 0||he===!0,G=ye.dataReady;let Re=j(M,et);W(s.TEXTURE_CUBE_MAP,M);let se;if($e){st&&Ct&&n.texStorage2D(s.TEXTURE_CUBE_MAP,Re,dt,et.width,et.height);for(let pe=0;pe<6;pe++){se=Oe[pe].mipmaps;for(let De=0;De<se.length;De++){const Le=se[De];M.format!==ci?nt!==null?st?G&&n.compressedTexSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+pe,De,0,0,Le.width,Le.height,nt,Le.data):n.compressedTexImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+pe,De,dt,Le.width,Le.height,0,Le.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):st?G&&n.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+pe,De,0,0,Le.width,Le.height,nt,ke,Le.data):n.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+pe,De,dt,Le.width,Le.height,0,nt,ke,Le.data)}}}else{if(se=M.mipmaps,st&&Ct){se.length>0&&Re++;const pe=Xe(Oe[0]);n.texStorage2D(s.TEXTURE_CUBE_MAP,Re,dt,pe.width,pe.height)}for(let pe=0;pe<6;pe++)if(Se){st?G&&n.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+pe,0,0,0,Oe[pe].width,Oe[pe].height,nt,ke,Oe[pe].data):n.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+pe,0,dt,Oe[pe].width,Oe[pe].height,0,nt,ke,Oe[pe].data);for(let De=0;De<se.length;De++){const ot=se[De].image[pe].image;st?G&&n.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+pe,De+1,0,0,ot.width,ot.height,nt,ke,ot.data):n.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+pe,De+1,dt,ot.width,ot.height,0,nt,ke,ot.data)}}else{st?G&&n.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+pe,0,0,0,nt,ke,Oe[pe]):n.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+pe,0,dt,nt,ke,Oe[pe]);for(let De=0;De<se.length;De++){const Le=se[De];st?G&&n.texSubImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+pe,De+1,0,0,nt,ke,Le.image[pe]):n.texImage2D(s.TEXTURE_CUBE_MAP_POSITIVE_X+pe,De+1,dt,nt,ke,Le.image[pe])}}}y(M)&&_(s.TEXTURE_CUBE_MAP),de.__version=ye.version,M.onUpdate&&M.onUpdate(M)}L.__version=M.version}function _e(L,M,J,he,ye,de){const We=l.convert(J.format,J.colorSpace),Ce=l.convert(J.type),Ke=I(J.internalFormat,We,Ce,J.colorSpace),$e=r.get(M),Se=r.get(J);if(Se.__renderTarget=M,!$e.__hasExternalTextures){const Oe=Math.max(1,M.width>>de),et=Math.max(1,M.height>>de);ye===s.TEXTURE_3D||ye===s.TEXTURE_2D_ARRAY?n.texImage3D(ye,de,Ke,Oe,et,M.depth,0,We,Ce,null):n.texImage2D(ye,de,Ke,Oe,et,0,We,Ce,null)}n.bindFramebuffer(s.FRAMEBUFFER,L),ft(M)?d.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,he,ye,Se.__webglTexture,0,pt(M)):(ye===s.TEXTURE_2D||ye>=s.TEXTURE_CUBE_MAP_POSITIVE_X&&ye<=s.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&s.framebufferTexture2D(s.FRAMEBUFFER,he,ye,Se.__webglTexture,de),n.bindFramebuffer(s.FRAMEBUFFER,null)}function me(L,M,J){if(s.bindRenderbuffer(s.RENDERBUFFER,L),M.depthBuffer){const he=M.depthTexture,ye=he&&he.isDepthTexture?he.type:null,de=b(M.stencilBuffer,ye),We=M.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,Ce=pt(M);ft(M)?d.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,Ce,de,M.width,M.height):J?s.renderbufferStorageMultisample(s.RENDERBUFFER,Ce,de,M.width,M.height):s.renderbufferStorage(s.RENDERBUFFER,de,M.width,M.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,We,s.RENDERBUFFER,L)}else{const he=M.textures;for(let ye=0;ye<he.length;ye++){const de=he[ye],We=l.convert(de.format,de.colorSpace),Ce=l.convert(de.type),Ke=I(de.internalFormat,We,Ce,de.colorSpace),$e=pt(M);J&&ft(M)===!1?s.renderbufferStorageMultisample(s.RENDERBUFFER,$e,Ke,M.width,M.height):ft(M)?d.renderbufferStorageMultisampleEXT(s.RENDERBUFFER,$e,Ke,M.width,M.height):s.renderbufferStorage(s.RENDERBUFFER,Ke,M.width,M.height)}}s.bindRenderbuffer(s.RENDERBUFFER,null)}function we(L,M){if(M&&M.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(s.FRAMEBUFFER,L),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const he=r.get(M.depthTexture);he.__renderTarget=M,(!he.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),ue(M.depthTexture,0);const ye=he.__webglTexture,de=pt(M);if(M.depthTexture.format===Oo)ft(M)?d.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,ye,0,de):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_ATTACHMENT,s.TEXTURE_2D,ye,0);else if(M.depthTexture.format===ko)ft(M)?d.framebufferTexture2DMultisampleEXT(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,ye,0,de):s.framebufferTexture2D(s.FRAMEBUFFER,s.DEPTH_STENCIL_ATTACHMENT,s.TEXTURE_2D,ye,0);else throw new Error("Unknown depthTexture format")}function He(L){const M=r.get(L),J=L.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==L.depthTexture){const he=L.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),he){const ye=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,he.removeEventListener("dispose",ye)};he.addEventListener("dispose",ye),M.__depthDisposeCallback=ye}M.__boundDepthTexture=he}if(L.depthTexture&&!M.__autoAllocateDepthBuffer){if(J)throw new Error("target.depthTexture not supported in Cube render targets");const he=L.texture.mipmaps;he&&he.length>0?we(M.__webglFramebuffer[0],L):we(M.__webglFramebuffer,L)}else if(J){M.__webglDepthbuffer=[];for(let he=0;he<6;he++)if(n.bindFramebuffer(s.FRAMEBUFFER,M.__webglFramebuffer[he]),M.__webglDepthbuffer[he]===void 0)M.__webglDepthbuffer[he]=s.createRenderbuffer(),me(M.__webglDepthbuffer[he],L,!1);else{const ye=L.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,de=M.__webglDepthbuffer[he];s.bindRenderbuffer(s.RENDERBUFFER,de),s.framebufferRenderbuffer(s.FRAMEBUFFER,ye,s.RENDERBUFFER,de)}}else{const he=L.texture.mipmaps;if(he&&he.length>0?n.bindFramebuffer(s.FRAMEBUFFER,M.__webglFramebuffer[0]):n.bindFramebuffer(s.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=s.createRenderbuffer(),me(M.__webglDepthbuffer,L,!1);else{const ye=L.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,de=M.__webglDepthbuffer;s.bindRenderbuffer(s.RENDERBUFFER,de),s.framebufferRenderbuffer(s.FRAMEBUFFER,ye,s.RENDERBUFFER,de)}}n.bindFramebuffer(s.FRAMEBUFFER,null)}function Ue(L,M,J){const he=r.get(L);M!==void 0&&_e(he.__webglFramebuffer,L,L.texture,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,0),J!==void 0&&He(L)}function tt(L){const M=L.texture,J=r.get(L),he=r.get(M);L.addEventListener("dispose",U);const ye=L.textures,de=L.isWebGLCubeRenderTarget===!0,We=ye.length>1;if(We||(he.__webglTexture===void 0&&(he.__webglTexture=s.createTexture()),he.__version=M.version,c.memory.textures++),de){J.__webglFramebuffer=[];for(let Ce=0;Ce<6;Ce++)if(M.mipmaps&&M.mipmaps.length>0){J.__webglFramebuffer[Ce]=[];for(let Ke=0;Ke<M.mipmaps.length;Ke++)J.__webglFramebuffer[Ce][Ke]=s.createFramebuffer()}else J.__webglFramebuffer[Ce]=s.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){J.__webglFramebuffer=[];for(let Ce=0;Ce<M.mipmaps.length;Ce++)J.__webglFramebuffer[Ce]=s.createFramebuffer()}else J.__webglFramebuffer=s.createFramebuffer();if(We)for(let Ce=0,Ke=ye.length;Ce<Ke;Ce++){const $e=r.get(ye[Ce]);$e.__webglTexture===void 0&&($e.__webglTexture=s.createTexture(),c.memory.textures++)}if(L.samples>0&&ft(L)===!1){J.__webglMultisampledFramebuffer=s.createFramebuffer(),J.__webglColorRenderbuffer=[],n.bindFramebuffer(s.FRAMEBUFFER,J.__webglMultisampledFramebuffer);for(let Ce=0;Ce<ye.length;Ce++){const Ke=ye[Ce];J.__webglColorRenderbuffer[Ce]=s.createRenderbuffer(),s.bindRenderbuffer(s.RENDERBUFFER,J.__webglColorRenderbuffer[Ce]);const $e=l.convert(Ke.format,Ke.colorSpace),Se=l.convert(Ke.type),Oe=I(Ke.internalFormat,$e,Se,Ke.colorSpace,L.isXRRenderTarget===!0),et=pt(L);s.renderbufferStorageMultisample(s.RENDERBUFFER,et,Oe,L.width,L.height),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+Ce,s.RENDERBUFFER,J.__webglColorRenderbuffer[Ce])}s.bindRenderbuffer(s.RENDERBUFFER,null),L.depthBuffer&&(J.__webglDepthRenderbuffer=s.createRenderbuffer(),me(J.__webglDepthRenderbuffer,L,!0)),n.bindFramebuffer(s.FRAMEBUFFER,null)}}if(de){n.bindTexture(s.TEXTURE_CUBE_MAP,he.__webglTexture),W(s.TEXTURE_CUBE_MAP,M);for(let Ce=0;Ce<6;Ce++)if(M.mipmaps&&M.mipmaps.length>0)for(let Ke=0;Ke<M.mipmaps.length;Ke++)_e(J.__webglFramebuffer[Ce][Ke],L,M,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+Ce,Ke);else _e(J.__webglFramebuffer[Ce],L,M,s.COLOR_ATTACHMENT0,s.TEXTURE_CUBE_MAP_POSITIVE_X+Ce,0);y(M)&&_(s.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(We){for(let Ce=0,Ke=ye.length;Ce<Ke;Ce++){const $e=ye[Ce],Se=r.get($e);n.bindTexture(s.TEXTURE_2D,Se.__webglTexture),W(s.TEXTURE_2D,$e),_e(J.__webglFramebuffer,L,$e,s.COLOR_ATTACHMENT0+Ce,s.TEXTURE_2D,0),y($e)&&_(s.TEXTURE_2D)}n.unbindTexture()}else{let Ce=s.TEXTURE_2D;if((L.isWebGL3DRenderTarget||L.isWebGLArrayRenderTarget)&&(Ce=L.isWebGL3DRenderTarget?s.TEXTURE_3D:s.TEXTURE_2D_ARRAY),n.bindTexture(Ce,he.__webglTexture),W(Ce,M),M.mipmaps&&M.mipmaps.length>0)for(let Ke=0;Ke<M.mipmaps.length;Ke++)_e(J.__webglFramebuffer[Ke],L,M,s.COLOR_ATTACHMENT0,Ce,Ke);else _e(J.__webglFramebuffer,L,M,s.COLOR_ATTACHMENT0,Ce,0);y(M)&&_(Ce),n.unbindTexture()}L.depthBuffer&&He(L)}function wt(L){const M=L.textures;for(let J=0,he=M.length;J<he;J++){const ye=M[J];if(y(ye)){const de=N(L),We=r.get(ye).__webglTexture;n.bindTexture(de,We),_(de),n.unbindTexture()}}}const at=[],k=[];function yn(L){if(L.samples>0){if(ft(L)===!1){const M=L.textures,J=L.width,he=L.height;let ye=s.COLOR_BUFFER_BIT;const de=L.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT,We=r.get(L),Ce=M.length>1;if(Ce)for(let $e=0;$e<M.length;$e++)n.bindFramebuffer(s.FRAMEBUFFER,We.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+$e,s.RENDERBUFFER,null),n.bindFramebuffer(s.FRAMEBUFFER,We.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+$e,s.TEXTURE_2D,null,0);n.bindFramebuffer(s.READ_FRAMEBUFFER,We.__webglMultisampledFramebuffer);const Ke=L.texture.mipmaps;Ke&&Ke.length>0?n.bindFramebuffer(s.DRAW_FRAMEBUFFER,We.__webglFramebuffer[0]):n.bindFramebuffer(s.DRAW_FRAMEBUFFER,We.__webglFramebuffer);for(let $e=0;$e<M.length;$e++){if(L.resolveDepthBuffer&&(L.depthBuffer&&(ye|=s.DEPTH_BUFFER_BIT),L.stencilBuffer&&L.resolveStencilBuffer&&(ye|=s.STENCIL_BUFFER_BIT)),Ce){s.framebufferRenderbuffer(s.READ_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.RENDERBUFFER,We.__webglColorRenderbuffer[$e]);const Se=r.get(M[$e]).__webglTexture;s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0,s.TEXTURE_2D,Se,0)}s.blitFramebuffer(0,0,J,he,0,0,J,he,ye,s.NEAREST),h===!0&&(at.length=0,k.length=0,at.push(s.COLOR_ATTACHMENT0+$e),L.depthBuffer&&L.resolveDepthBuffer===!1&&(at.push(de),k.push(de),s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,k)),s.invalidateFramebuffer(s.READ_FRAMEBUFFER,at))}if(n.bindFramebuffer(s.READ_FRAMEBUFFER,null),n.bindFramebuffer(s.DRAW_FRAMEBUFFER,null),Ce)for(let $e=0;$e<M.length;$e++){n.bindFramebuffer(s.FRAMEBUFFER,We.__webglMultisampledFramebuffer),s.framebufferRenderbuffer(s.FRAMEBUFFER,s.COLOR_ATTACHMENT0+$e,s.RENDERBUFFER,We.__webglColorRenderbuffer[$e]);const Se=r.get(M[$e]).__webglTexture;n.bindFramebuffer(s.FRAMEBUFFER,We.__webglFramebuffer),s.framebufferTexture2D(s.DRAW_FRAMEBUFFER,s.COLOR_ATTACHMENT0+$e,s.TEXTURE_2D,Se,0)}n.bindFramebuffer(s.DRAW_FRAMEBUFFER,We.__webglMultisampledFramebuffer)}else if(L.depthBuffer&&L.resolveDepthBuffer===!1&&h){const M=L.stencilBuffer?s.DEPTH_STENCIL_ATTACHMENT:s.DEPTH_ATTACHMENT;s.invalidateFramebuffer(s.DRAW_FRAMEBUFFER,[M])}}}function pt(L){return Math.min(a.maxSamples,L.samples)}function ft(L){const M=r.get(L);return L.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function Ye(L){const M=c.render.frame;g.get(L)!==M&&(g.set(L,M),L.update())}function Rt(L,M){const J=L.colorSpace,he=L.format,ye=L.type;return L.isCompressedTexture===!0||L.isVideoTexture===!0||J!==Xs&&J!==Sr&&(Tt.getTransfer(J)===bt?(he!==ci||ye!==Gi)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",J)),M}function Xe(L){return typeof HTMLImageElement<"u"&&L instanceof HTMLImageElement?(m.width=L.naturalWidth||L.width,m.height=L.naturalHeight||L.height):typeof VideoFrame<"u"&&L instanceof VideoFrame?(m.width=L.displayWidth,m.height=L.displayHeight):(m.width=L.width,m.height=L.height),m}this.allocateTextureUnit=ee,this.resetTextureUnits=re,this.setTexture2D=ue,this.setTexture2DArray=le,this.setTexture3D=oe,this.setTextureCube=B,this.rebindTextures=Ue,this.setupRenderTarget=tt,this.updateRenderTargetMipmap=wt,this.updateMultisampleRenderTarget=yn,this.setupDepthRenderbuffer=He,this.setupFrameBufferTexture=_e,this.useMultisampledRTT=ft}function VM(s,e){function n(r,a=Sr){let l;const c=Tt.getTransfer(a);if(r===Gi)return s.UNSIGNED_BYTE;if(r===Zf)return s.UNSIGNED_SHORT_4_4_4_4;if(r===Qf)return s.UNSIGNED_SHORT_5_5_5_1;if(r===og)return s.UNSIGNED_INT_5_9_9_9_REV;if(r===rg)return s.BYTE;if(r===sg)return s.SHORT;if(r===Uo)return s.UNSIGNED_SHORT;if(r===Kf)return s.INT;if(r===Jr)return s.UNSIGNED_INT;if(r===Bi)return s.FLOAT;if(r===zo)return s.HALF_FLOAT;if(r===ag)return s.ALPHA;if(r===lg)return s.RGB;if(r===ci)return s.RGBA;if(r===Oo)return s.DEPTH_COMPONENT;if(r===ko)return s.DEPTH_STENCIL;if(r===ug)return s.RED;if(r===Jf)return s.RED_INTEGER;if(r===cg)return s.RG;if(r===ed)return s.RG_INTEGER;if(r===td)return s.RGBA_INTEGER;if(r===Ml||r===Tl||r===wl||r===Al)if(c===bt)if(l=e.get("WEBGL_compressed_texture_s3tc_srgb"),l!==null){if(r===Ml)return l.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===Tl)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===wl)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===Al)return l.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(l=e.get("WEBGL_compressed_texture_s3tc"),l!==null){if(r===Ml)return l.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===Tl)return l.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===wl)return l.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===Al)return l.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===vf||r===_f||r===xf||r===yf)if(l=e.get("WEBGL_compressed_texture_pvrtc"),l!==null){if(r===vf)return l.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===_f)return l.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===xf)return l.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===yf)return l.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===Sf||r===Ef||r===Mf)if(l=e.get("WEBGL_compressed_texture_etc"),l!==null){if(r===Sf||r===Ef)return c===bt?l.COMPRESSED_SRGB8_ETC2:l.COMPRESSED_RGB8_ETC2;if(r===Mf)return c===bt?l.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:l.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===Tf||r===wf||r===Af||r===Cf||r===Rf||r===bf||r===Pf||r===Lf||r===Df||r===If||r===Nf||r===Uf||r===Ff||r===Of)if(l=e.get("WEBGL_compressed_texture_astc"),l!==null){if(r===Tf)return c===bt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:l.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===wf)return c===bt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:l.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===Af)return c===bt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:l.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===Cf)return c===bt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:l.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===Rf)return c===bt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:l.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===bf)return c===bt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:l.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===Pf)return c===bt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:l.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===Lf)return c===bt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:l.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===Df)return c===bt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:l.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===If)return c===bt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:l.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===Nf)return c===bt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:l.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===Uf)return c===bt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:l.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===Ff)return c===bt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:l.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===Of)return c===bt?l.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:l.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===Cl||r===kf||r===Bf)if(l=e.get("EXT_texture_compression_bptc"),l!==null){if(r===Cl)return c===bt?l.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:l.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===kf)return l.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===Bf)return l.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===fg||r===zf||r===Hf||r===Vf)if(l=e.get("EXT_texture_compression_rgtc"),l!==null){if(r===Cl)return l.COMPRESSED_RED_RGTC1_EXT;if(r===zf)return l.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===Hf)return l.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===Vf)return l.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===Fo?s.UNSIGNED_INT_24_8:s[r]!==void 0?s[r]:null}return{convert:n}}const GM=`
void main() {
